	...
	<nav id="menu" class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<h1 style="color: white">Attribute based Encryption and Outsourced Decryption for Both Users and Cloud Server in Cloud Computing
</h1>
				</br>
				<ul class="nav navbar-nav">
					<li ><a href="index.html">Home</a></li>
					<li><a href="userlog.jsp">User</a></li>
					<li class="active"><a href="ownerlog.jsp">Owner</a></li>
...
<div align="center">
						<form action="usereg2.jsp" style="background-color: #000000c9;width: fit-content;border-radius: 10px;padding: 10px;">

							<h2 align="center" style="color: ">Owner Registration
							</h2>
							<table align="center"  >
