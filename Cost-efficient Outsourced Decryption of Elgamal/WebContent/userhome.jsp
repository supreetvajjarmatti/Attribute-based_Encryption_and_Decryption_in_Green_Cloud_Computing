...
<table cellspacing="8" border="2" width="60%" style="background-color: black"> 
			<tr>
				<th style="color: #FCAE1E"><center>Name</th>
				<th style="color: #FCAE1E"><center>Email</th>
				<th style="color: #FCAE1E"><center>Phone</th>
				<th style="color: #FCAE1E"><center>Gender</th>
				<th style="color: #FCAE1E"><center>Address</th>
				<th style="color: #FCAE1E"><center>Update</th>
			...
			try {
				...
				PreparedStatement pstmt = con.prepareStatement("select * from user  where uid=? ");/* where uid=? */
	...
	<tr>
				...
				<td align="center"><font color="White"><a href="userupdate.jsp" style="font-weight: bold;color: #0bf40a">Update</a></font></td>
