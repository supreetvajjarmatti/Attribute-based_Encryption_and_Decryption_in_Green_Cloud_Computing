        ...
        <div class="row">
          <div class="intro-text">
            <div align="center">
            	...
            	<tr align="center" style="color:#FCAE1E ">
            	    <th>id</th>
            		<th>File Name</th>
            		<th>Uploaded File</th>
            		<th>Delete</th>
			 ...
			 <td style="border: 1px solid white"><a href="del.jsp?fid=<%=rs.getInt(1)%>"><font style="color: #FF7F7F"><b>Delete</b></font></a>
			 <td style="border: 1px solid white"><a href="encimg.jsp?fid=<%=rs.getInt(1)%>"><font style="color: #1Fd655"><b>Download</b></font></a>
			 <td style="border: 1px solid white"><a href="graph.jsp?fid=<%=rs.getInt(1)%>"><font style="color: #1Fd655"><b>Graph</b></font></a>
			</tr>
